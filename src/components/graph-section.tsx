...
import { ChartInOut } from "./charts/chart-in-out";
import { ProtocolsChart } from "./charts/protocols-chart";
...
export const GraphSection = ({ inOutData, protocolsData }: GraphSectionProps) => {
  ...
  return (
    <div className="bg-card flex flex-col md:flex-row justify-evenly 2xl:flex-col h-fit rounded-[16px] p-6 2xl:mt-11">
